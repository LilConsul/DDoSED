...
# CRITICAL FIX: Normalize inconsistent labels from the Kaggle dataset
LABEL_MAP = {
    "DrDoS_UDP": "UDP",
    "UDP-lag": "UDP",
    "UDPLag": "UDP",
...
def preprocess_data():
    # 1. Load native train/test split
    ...
    # 4. Drop highly correlated columns (fixed pd.np -> np)
    ...
    return X_train, X_test, y_train, y_test, label_names, feature_names
